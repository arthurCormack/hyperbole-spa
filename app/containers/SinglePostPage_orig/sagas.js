...
import { loadPostData, postDataLoaded, postDataLoadingError } from 'containers/App/actions';
import { SET_SCROLLTOP } from 'containers/App/constants';
import { updateWindowScrollPosition, createCB } from './actions';
import interstitialAdHolderSaga from 'containers/InterstitialAdHolder/sagas';

import { LOAD_POSTDATA_SUCCESS, LOAD_POSTDATA_ERROR, LOAD_POSTDATA, APICALLURL_GETDATEDPOST } from 'containers/App/constants';
...
import { SET_CURRENTLYDISPLAYEDITEMINDEX, DEDUCE_CURRENTLYDISPLAYED_ITEMINDEX, SET_CURRENTPOSTSTACKDISPLAYDATA, BOTTOMOFSTACKREACHED } from './constants';
...
export function* getCurrentPostStackDisplayDataWatcher() {
  ...
  while (true) {
    ...
    // console.log('saga take(SET_CURRENTPOSTSTACKDISPLAYDATA)');
