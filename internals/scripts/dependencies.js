...
echo('finished ...writeFile dllManifestPath');
...
// --debug
exec('cross-env BUILDING_DLL=true webpack --display-chunks --progress --display-error-details --color --config internals/webpack/webpack.dll.babel.js --hide-modules');
