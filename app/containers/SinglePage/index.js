...
import makeSelectSinglePage from './selectors';
import reducer from './reducer';
import saga from './saga';

export class SinglePage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  render() {
    return (
      <div>
        <Helmet>
          <title>SinglePage</title>
          <meta name="description" content="Description of SinglePage" />
        </Helmet>
...
const mapStateToProps = createStructuredSelector({
  singlepage: makeSelectSinglePage(),
});
...
const withReducer = injectReducer({ key: 'singlePage', reducer });
const withSaga = injectSaga({ key: 'singlePage', saga });
//
